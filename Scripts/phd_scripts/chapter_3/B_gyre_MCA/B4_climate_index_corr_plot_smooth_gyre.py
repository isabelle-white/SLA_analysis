# """
# B4_climate_index_corr_plot_gyre.py
# Load sector/gyre saved scores and comps
# Load the climate index
# Plot time series of the different modes and calcualte correlations with 3 month smoothing (rolling average)
#
...
if gyre_name == 'ross':
    ...
    fig_dir = fig_dir + 'ross/climate_indices/'
    ...
    vars_dir = sector_dir + 'preprocessed_vars/'
    scores_comps_dir = sector_dir + 'scores_comps/'
    fig_dir = fig_dir + 'weddell/climate_indices/'
    ...
    vars_dir = sector_dir + 'preprocessed_vars/'
    scores_comps_dir = sector_dir + 'scores_comps/'
    fig_dir = fig_dir + 'kerguelen/climate_indices/'
    crosses_dateline = False # set to False for normal sectors (<0 then >0)


save_dir = fig_dir +f'{clim_idx}/'+ f'{var_1_name}_{var_2_name}/'
...
for i, ax in enumerate(axes):
    ...
    print('3 mmonth rolling mean on scores')
    ...
    ax.plot(index_norm.time, index_smooth, '--', color='black', label=f'{clim_idx}')
...
fig.suptitle(f'{var_1_name} - {var_2_name} MCA modes vs {clim_idx}, (smoothed) ', fontsize=20, fontweight='bold')
fig.tight_layout(rect=[0, 0.03, 1, 0.98])


save_name = f'timeseries_corr_{var_1_name}_{var_2_name}_{start_time}_{end_time}_{gyre_name}_smooth.png'
