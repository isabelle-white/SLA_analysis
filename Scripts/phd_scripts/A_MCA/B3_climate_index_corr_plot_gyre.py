"""
B3_climate_index_corr_plot_gyre.py
Load sector/gyre saved scores and comps
Load the climate index
Plot time series of the different modes and calcualte correlations
...
save_name = f'timeseries_corr_{var_1_name}_{var_2_name}_{start_time}_{end_time}_{gyre_name}.png'
