...
var_1_name  = 'total_ws'
var_2_name  = 'sla'
sector_name = 'Ross' # keep to full and use A2c for a sector
...
# stereo plot for var 1 (comps 1)
fig1, ax1, _ = st.spstere_plot(
    llon, llat, comp1_m.values,
    vlims_1, cmap_1, cbar_units_1, bcolor=None
)
...
fig2, ax2, _ = st.spstere_plot(
    ...
    vlims_2, cmap_2, cbar_units_2, bcolor=None
)
